# -*- coding: utf-8 -*-
"""version_2_mejorada_modelo_asistente_virtual_para_ciencia_abierta.ipynb
...
* Luego de que el documento fue segmentado en chunks de 500-1000 tokens, se procede a la limpieza y normalización de texto en español
...
## Se complementa con la notebook parte_4
...
# Asegúrate de tener instalada la librería de Hugging Face si la vas a usar,
# por ejemplo: from langchain_community.llms import HuggingFaceHub
